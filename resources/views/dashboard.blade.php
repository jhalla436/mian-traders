...
<div class="metrics-row">
  ...
  <div class="metric-card blue">
    ...
    <div class="metric-footer">
      ...
      @if($canSeeCost)
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Realized: {{ number_format((float)($realizedToday ?? 0), 0) }}</span>
      @endif
    </div>
  </div>
  <div class="metric-card purple">
    ...
    <div class="metric-footer">
      ...
      @if($canSeeCost)
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Realized: {{ number_format((float)($realizedThisWeek ?? 0), 0) }}</span>
      @endif
    </div>
  </div>
  <div class="metric-card teal">
    ...
    <div class="metric-footer">
      ...
      @if($canSeeCost)
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Realized: {{ number_format((float)($realizedThisMonth ?? 0), 0) }}</span>
      @endif
    </div>
  </div>
</div>
          ...
          @foreach($recentSales as $s)
            <tr>
              ...
              <td>
                ...
                @if($s->customer_phone)<div class="customer-phone">{{ $s->customer_phone }}</div>@endif
              </td>
      ...
      <div style="display:flex; flex-direction:column; gap:16px;">
        ...
        <div>
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
            ...
            <span style="font-size:14px; font-weight:800; color:#16a34a;">{{ number_format((float)($realizedToday ?? 0), 0) }}</span>
          </div>
          <div style="font-size:10px; color:#94a3b8; text-align:right;">
            Total: {{ number_format((float)($profitToday ?? 0), 0) }}
          </div>
        </div>
        ...
        <div>
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
            ...
            <span style="font-size:14px; font-weight:800; color:#16a34a;">{{ number_format((float)($realizedThisWeek ?? 0), 0) }}</span>
          </div>
          <div style="font-size:10px; color:#94a3b8; text-align:right;">
            Total: {{ number_format((float)($profitThisWeek ?? 0), 0) }}
          </div>
        </div>
        ...
        <div>
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
            ...
            <span style="font-size:14px; font-weight:800; color:#16a34a;">{{ number_format((float)($realizedThisMonth ?? 0), 0) }}</span>
          </div>
          <div style="font-size:10px; color:#94a3b8; text-align:right;">
            Total: {{ number_format((float)($profitThisMonth ?? 0), 0) }}
          </div>
        </div>
      </div>
    </div>
