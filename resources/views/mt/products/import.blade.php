...
<div class="card" style="max-width:860px;">
  <div class="text-muted text-sm" style="margin-bottom:16px;line-height:1.6;">
    ...
    <div style="margin-top:6px;">
      <a href="{{ route('mt.products.import_template') }}" style="color:#6366f1;font-weight:700;">Download CSV Template</a>
    </div>
  </div>

  <form method="POST" action="{{ route('mt.products.import_process') }}" enctype="multipart/form-data" class="form-stack">
    @csrf
