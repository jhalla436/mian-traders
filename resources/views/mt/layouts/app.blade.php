...
<div class="mt-app">
  ...
  <aside class="mt-sidebar" id="appSidebar">
    ...
    <div class="mt-brand">
      ...
      <div>
        <div class="mt-brand-text">{{ config('app.name', 'Mian Traders') }}</div>
        <div class="mt-brand-sub">Business Suite</div>
      </div>
    </div>

    <div class="mt-sidebar-inner">
      <div class="mt-role-badge"><span class="mt-role-dot"></span> {{ $role }}</div>

      <div class="mt-shop-card">
        <div class="mt-shop-label">Active Shop</div>
        <form method="POST" action="{{ route('mt.shops.switch') }}">
          @csrf
          <select name="shop_id" onchange="this.form.submit()" class="mt-shop-select">
            @if($role === 'admin')
              <option value="all" {{ $activeShopId === 'all' ? 'selected' : '' }}>All Shops</option>
            @endif
            @foreach($allowedShops as $s)
              <option value="{{ $s->id }}" {{ (string)$activeShopId === (string)$s->id ? 'selected' : '' }}>{{ $s->name ?? ('Shop #' . $s->id) }}</option>
            @endforeach
          </select>
        </form>
        @if($activeShop)
          <div class="mt-shop-info"><b>{{ $activeShop->name }}</b>@if($activeShop->owner_name)<br>Owner: {{ $activeShop->owner_name }}@endif</div>
        @endif
      </div>

      <div class="mt-section-label">Main</div>
      <a href="{{ route('dashboard') }}" class="mt-nav-link{{ $isRouteActive('dashboard') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.analytics.index') }}" class="mt-nav-link{{ $isRouteActive('mt.analytics.index') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.pos.index') }}" target="_blank" class="mt-nav-link{{ $isRouteActive('mt.pos.*') ? ' active' : '' }}">
        ...
        <span>POS</span></a>
      <a href="{{ route('mt.products.index') }}" class="mt-nav-link{{ $isRouteActive('mt.products.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.sales.index') }}" class="mt-nav-link{{ $isRouteActive('mt.sales.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.udhar.index') }}" class="mt-nav-link{{ $isRouteActive('mt.udhar.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.products.import_form') }}" class="mt-nav-link{{ $isRouteActive('mt.products.import_form') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.purchases.index') }}" class="mt-nav-link{{ $isRouteActive('mt.purchases.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.company_orders.index') }}" class="mt-nav-link{{ $isRouteActive('mt.company_orders.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.categories.index') }}" class="mt-nav-link{{ $isRouteActive('mt.categories.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.companies.index') }}" class="mt-nav-link{{ $isRouteActive('mt.companies.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.sheet_designs.index') }}" class="mt-nav-link{{ $isRouteActive('mt.sheet_designs.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.company_brochures.index') }}" class="mt-nav-link{{ $isRouteActive('mt.company_brochures.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.company_groups.index') }}" class="mt-nav-link{{ $isRouteActive('mt.company_groups.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.stock_movements.index') }}" class="mt-nav-link{{ $isRouteActive('mt.stock_movements.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.discount_types.index') }}" class="mt-nav-link{{ $isRouteActive('mt.discount_types.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.discount_rules.index') }}" class="mt-nav-link{{ $isRouteActive('mt.discount_rules.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.expenses.index') }}" class="mt-nav-link{{ $isRouteActive('mt.expenses.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.recurring_expenses.index') }}" class="mt-nav-link{{ $isRouteActive('mt.recurring_expenses.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.shops.index') }}" class="mt-nav-link{{ $isRouteActive('mt.shops.*') ? ' active' : '' }}">
        ...
        <span>Shops</span></a>
      <a href="{{ route('mt.users.index') }}" class="mt-nav-link{{ $isRouteActive('mt.users.*') ? ' active' : '' }}">
        ...
        <span>Users</span></a>
      <a href="{{ route('mt.system_reset.index') }}" class="mt-nav-link{{ $isRouteActive('mt.system_reset.*') ? ' active' : '' }}">
      ...
      <a href="{{ route('mt.whatsapp.index') }}" class="mt-nav-link{{ $isRouteActive('mt.whatsapp.*') ? ' active' : '' }}">
  ...
  {{-- ═══════════════ MAIN ═══════════════ --}}
  <div class="mt-main">
    @if(session()->has('success') && trim((string) session('success')) !== '')
