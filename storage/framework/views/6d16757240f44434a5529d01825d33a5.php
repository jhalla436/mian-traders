...
<div class="metrics-row">
  ...
  <div class="metric-card blue">
    ...
    <div class="metric-footer">
      ...
      <?php if($canSeeCost): ?>
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Profit: <?php echo e(number_format((float)($profitToday ?? 0), 0)); ?></span>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="metric-card purple">
    ...
    <div class="metric-footer">
      ...
      <?php if($canSeeCost): ?>
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Profit: <?php echo e(number_format((float)($profitThisWeek ?? 0), 0)); ?></span>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="metric-card teal">
    ...
    <div class="metric-footer">
      ...
      <?php if($canSeeCost): ?>
        <span class="metric-sub" style="color:#16a34a;font-weight:700;">Profit: <?php echo e(number_format((float)($profitThisMonth ?? 0), 0)); ?></span>
      <?php endif; ?>
    </div>
  </div>
</div>
            ...
            <tr>
              ...
              <td>
                ...
                <?php if($s->customer_phone): ?>
                  <div class="customer-phone"><?php echo e($s->customer_phone); ?></div>
                <?php endif; ?>
              </td>
    ...
    <div class="dash-card" style="padding:24px;">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;">
        <div style="display:flex;justify-content:space-between;align-items:center;">
          ...
          <span style="font-size:15px;font-weight:800;color:#16a34a;"><?php echo e(number_format((float)($profitToday ?? 0), 0)); ?></span>
        </div>
        <div style="background:#f1f5f9;height:1px;"></div>
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:13px;color:#64748b;font-weight:500;">This Week</span>
          <span style="font-size:15px;font-weight:800;color:#16a34a;"><?php echo e(number_format((float)($profitThisWeek ?? 0), 0)); ?></span>
        </div>
        <div style="background:#f1f5f9;height:1px;"></div>
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:13px;color:#64748b;font-weight:500;">This Month</span>
          <span style="font-size:15px;font-weight:800;color:#16a34a;"><?php echo e(number_format((float)($profitThisMonth ?? 0), 0)); ?></span>
        </div>
      </div>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('mt.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mian-traders\resources\views\mt\dashboard.blade.php ENDPATH**/ ?>