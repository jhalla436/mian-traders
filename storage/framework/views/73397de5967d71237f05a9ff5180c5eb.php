...
<?php $__env->startSection('title', 'Price Import'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
  <h2 class="page-title">Import Price List</h2>
...
<div class="mt-tabs" style="margin-bottom: 20px;">
  <a href="<?php echo e(route('mt.products.price_import_form')); ?>" class="mt-tab active">CSV / Text Import</a>
  <a href="<?php echo e(route('mt.products.price_import_pdf_form')); ?>" class="mt-tab">PDF Price List Parser</a>
</div>

<div class="card" style="max-width:860px;">
  <div class="card-body">
    <p class="text-muted">Upload a CSV with either columns <b>name</b> + <b>price</b> or a supplier format like <b>product_key,length,width,height,type,price</b>. Missing products will be auto-created and shop selling prices updated.</p>

    <form method="POST" action="<?php echo e(route('mt.products.price_import_process')); ?>" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        <label>Default Company (used to infer buy price rules)</label>
      ...
      <div class="form-group">
        ...
        <textarea name="paste" rows="6" class="form-control"></textarea>
      </div>

      <div class="form-check mb-3">
        <input type="checkbox" name="dry_run" value="1" id="dry_run" class="form-check-input">
        <label for="dry_run" class="form-check-label">Dry run (no writes)</label>
      </div>
    ...
    <?php if(isset($report)): ?>
      <hr>
      <h4>Report <?php if(!empty($dry_run)): ?> (dry run) <?php endif; ?></h4>
      <ul>
        <li>Total rows: <?php echo e($report['total']); ?></li>
        <li>Products auto-created: <?php echo e($report['created_products']); ?></li>
        <li>Shop prices created: <?php echo e($report['created_shop_prices']); ?></li>
        <li>Shop prices updated: <?php echo e($report['updated_shop_prices']); ?></li>
      </ul>
        ...
        <table class="table">
          ...
          <tbody>
            <?php $__currentLoopData = $report['failed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr><td><?php echo e($f['row']); ?></td><td><?php echo e($f['reason']); ?></td></tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
        </table>
      <?php endif; ?>
...
<?php echo $__env->make('mt.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mian-traders\resources\views/mt/import/price_import.blade.php ENDPATH**/ ?>