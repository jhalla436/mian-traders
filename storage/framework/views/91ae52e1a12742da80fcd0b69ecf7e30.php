            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $parsedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  ...
                  <td style="padding: 8px 14px;">
                    <input type="number" step="0.01" name="items[<?php echo e($idx); ?>][purchase_price]" value="<?php echo e($item['purchase_price'] ?? ''); ?>" class="mt-input" style="padding:4px 8px; font-size:12px; min-height:28px; text-align:right; font-weight:700; color:#166534;" readonly />
                  </td>
                </tr>
