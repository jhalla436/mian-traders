...
?>
  ...
  <form id="order_form" method="POST" action="<?php echo e(route('mt.company_orders.store')); ?>" class="form-stack">
    <?php echo csrf_field(); ?>
    ...
    <div class="card">
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="date" name="order_date" value="<?php echo e(old('order_date', now()->toDateString())); ?>" required class="mt-input">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group" style="margin-top: 12px;">
        ...
        <input name="note" value="<?php echo e(old('note')); ?>" class="mt-input" placeholder="Optional notes for this purchase order">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card" id="grid_card" style="display: none; padding: 0; overflow: hidden; border-radius: 14px; border: 1px solid rgba(0,0,0,0.06); box-shadow: 0 4px 20px rgba(0,0,0,0.04);">
      ...
      <div style="padding: 16px 20px; background: #f8fafc; border-top: 2px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div style="font-size: 13px; color: #64748b;">
          ...
          Selected for Order: <span id="lbl_selected_count" class="font-bold" style="color:#22c55e;">0</span>
        </div>
  ...
  <script>
    ...
    async function loadCompanyProducts(companyId) {
      ...
      try {
        const url = `<?php echo e(route('mt.company_orders.products')); ?>?company_id=${encodeURIComponent(companyId)}`;
    ...
    function applyFilters() {
      ...
      document.querySelectorAll('#grid_body tr.grid-product-row').forEach(tr => {
        ...
        let matchQ = !q || name.includes(q) || sku.includes(q);
