        ...
        <?php $__currentLoopData = $companyGroup['families']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $familyName => $familyProducts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php $__currentLoopData = $familyProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="js-family-variant-row <?php echo e($familyKey); ?>" style="<?php echo e($displayStyle); ?>">
              ...
              ?>
              <?php if(\App\Support\ShopContext::isAll()): ?>
                <td class="text-right" style="color: #1e293b; padding: 8px 12px; vertical-align: top;">
                  <span class="font-bold"><?php echo e(number_format((float)$p->stock_qty, 2)); ?></span>
                  <?php
                    $hasStockBreakdown = collect($shopBreakdown)->filter(fn($spItem) => (float)$spItem['stock_qty'] > 0)->isNotEmpty();
                  ?>
                  <?php if($hasStockBreakdown): ?>
                    <div style="font-size: 11px; color: #64748b; margin-top: 4px; line-height: 1.4; text-align: right;">
                      <?php $__currentLoopData = $shopBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if((float)$spItem['stock_qty'] > 0): ?>
                          <div style="white-space: nowrap;">
                            <span style="color:#cbd5e1; font-size:10px;">↳</span> 
                            <span style="font-weight: 500;"><?php echo e($spItem['shop_name']); ?>:</span> <?php echo e(number_format((float)$spItem['stock_qty'], 2)); ?>
              ...
              <td>
                <div class="actions">
                  <?php if(auth()->user()?->role !== 'cashier'): ?>
                    <a href="<?php echo e(route('mt.products.edit', $p->id)); ?>" class="btn btn-secondary btn-xs">Edit</a>
                  <?php else: ?>
