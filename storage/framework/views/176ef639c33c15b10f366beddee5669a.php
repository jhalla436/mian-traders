...
<div class="page-header">
  <div>
    ...
    <div class="page-subtitle">
      ...
      Total matching: <b><?php echo e((int)($totalCount ?? 0)); ?></b>
    </div>
  </div>
  <div class="page-actions">
    <form method="GET" class="flex gap-8 items-center flex-wrap">
      <input name="q" value="<?php echo e($q ?? ''); ?>" placeholder="Search phone/name..." class="mt-input" style="min-width:200px;">
      <input type="hidden" name="type" value="<?php echo e($type); ?>">
      <button class="btn btn-primary btn-sm">Search</button>
      <a href="<?php echo e(route('mt.whatsapp.index', ['type'=>$type])); ?>" class="btn btn-outline btn-sm">Clear</a>
      <a href="<?php echo e(route('mt.whatsapp.export', ['type'=>$type, 'q'=>$q])); ?>" class="btn btn-secondary btn-sm">Download CSV</a>
    </form>
  </div>
</div>
...
<div class="filter-bar" style="justify-content:space-between;">
  <div class="mt-tabs">
    <a href="<?php echo e(route('mt.whatsapp.index', ['type'=>'udhar', 'q'=>$q])); ?>" class="mt-tab<?php echo e($isType('udhar') ? ' active' : ''); ?>">Udhar Customers</a>
    <a href="<?php echo e(route('mt.whatsapp.index', ['type'=>'walkin', 'q'=>$q])); ?>" class="mt-tab<?php echo e($isType('walkin') ? ' active' : ''); ?>">Walk-in / Paid</a>
    <a href="<?php echo e(route('mt.whatsapp.index', ['type'=>'all', 'q'=>$q])); ?>" class="mt-tab<?php echo e($isType('all') ? ' active' : ''); ?>">All</a>
  </div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:start;">
  <div class="card">
    ...
    <textarea id="waBox" rows="10" class="mt-input" style="margin-top:12px;resize:vertical;"><?php echo e($numbersWa ?? ''); ?></textarea>
  ...
  <div class="card">
    ...
    <textarea id="origBox" rows="10" class="mt-input" style="margin-top:12px;resize:vertical;"><?php echo e($numbersOriginal ?? ''); ?></textarea>
  ...
  <table class="mt-table" style="margin-top:12px;">
    ...
    <tbody>
      <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        ?>
        <tr>
          <td class="font-bold"><?php echo e($r->customer_name ?? '-'); ?></td>
          <td>
            <?php $__currentLoopData = [$p1,$p2,$p3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(!empty($pp)): ?>
                ...
                <div class="flex gap-8 items-center" style="margin-bottom:4px;">
                  ...
                  <?php if($wa): ?>
                    <a href="<?php echo e($wa); ?>" target="_blank" class="badge-wa">WA</a>
                  <?php endif; ?>
                </div>
              <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if(empty($p1) && empty($p2) && empty($p3)): ?> - <?php endif; ?>
          </td>
          <td class="text-right"><?php echo e(number_format((float)($r->total_sales ?? 0), 2)); ?></td>
          <td class="text-right">
            <span class="font-bold <?php echo e((float)($r->total_udhar ?? 0) > 0 ? 'text-danger' : 'text-success'); ?>">
              <?php echo e(number_format((float)($r->total_udhar ?? 0), 2)); ?>

            </span>
          </td>
          <td><?php echo e($r->last_purchase ?? '-'); ?></td>
          <td>
            <div class="actions">
              <?php if(!empty($p1)): ?>
                <a href="<?php echo e(route('mt.customers.profile', $p1)); ?>" class="btn btn-primary btn-xs">Profile</a>
              <?php endif; ?>
              <?php if(!empty($p1) && (float)($r->total_udhar ?? 0) > 0): ?>
                <a href="<?php echo e(route('mt.udhar.show', $p1)); ?>" class="btn btn-secondary btn-xs">Udhar</a>
              <?php endif; ?>
            </div>
          </td>
        </tr>
